 ...
 * of the double-double numbers. Results are returned as a new double-double instance.
...
//    private static long mdd;
     ...
     */
    private static final class MDD2 {
        /** The high part of the double-double number. */
        private double hi;
        /** The low part of the double-double number. */
        private double lo;
...
//            mdd++;
     ...
     * @param lo Low part.
     */
    private DD2(double hi, double lo) {
        this.hi = hi;
        this.lo = lo;
//        dd++;
    }
...
//    }
     ...
     * @return the double-double
     */
    static DD2 create(double a, double b) {
        return twoSum(a, b);
    }
     ...
     * @return the result
     */
    private DD2 subtractLow(double x) {
        return new DD2(hi, lo - x);
    }
     ...
     */
    static DD2 fastTwoSum(double a, double b) {
        // (x, xx) = a + b
        // bVirtual = x - a
        // xx = b - bVirtual
        final double x = a + b;
     ...
     * @see #fastTwoSum(double, double, DD2)
     */
     ...
     * Shewchuk (1997) Theorum 6</a>
     */
    static DD2 fastTwoDiff(double a, double b) {
        // (x, xx) = a - b
        // bVirtual = a - x
        // xx = bVirtual - b
        final double x = a - b;
     ...
     */
    static DD2 twoSum(double a, double b) {
        // (x, xx) = a + b
        // bVirtual = x - a
        // aVirtual = x - bVirtual
     ...
     */
    static DD2 twoDiff(double a, double b) {
        // (x, xx) = a - b
        // bVirtual = a - x
        // aVirtual = x + bVirtual
        // bRoundoff = b - bVirtual
     ...
     */
    static DD2 fastAdd(double x, double xx, double y) {
        // (s0, s1) = x + y
        final double s0 = x + y;
     ...
     */
    static DD2 add(double x, double xx, double y) {
     ...
     * @see #add(double, double, double, double)
     */
    static DD2 fastAdd(double x, double xx, double y, double yy) {
        // Sum parts and save
        // (p, pp) = x + y
        DD2 s = twoSum(x, y);
        final double p = s.hi;
     ...
     * @see #fastAdd(double, double, double, double)
     */
    static DD2 add(double x, double xx, double y, double yy) {
     ...
     */
    static DD2 multiply(double x, double xx, double y) {
        // Dekker mul2 with yy=0
        // (Alternative: Scale expansion (Schewchuk Fig 13))
        final DD2 p = twoProd(x, y);
     ...
     * @return the product
     */
    static DD2 multiply(double x, double xx, double y, double yy) {
        // Dekker mul2
        // (Alternative: Scale expansion (Schewchuk Fig 13))
        final DD2 p = twoProd(x, y);
     ...
     * @see #multiply(double, double, double, double)
     */
    static DD2 uncheckedMultiply(double x, double xx, double y, double yy) {
        // Dekker mul2
        final double hi = x * y;
     ...
     * @return the quotient
     */
    static DD2 divide(double x, double y) {
        // Long division
        // quotient q0 = x / y
        final double q0 = x / y;
        // remainder r = x - q0 * y
     ...
     * @return the quotient
     */
    static DD2 uncheckedDivide(double x, double y) {
        // Long division
        // quotient q0 = x / y
        final double q0 = x / y;
        // remainder r = x - q0 * y
     ...
     * @return the quotient
     */
    static DD2 divide(double x, double xx, double y, double yy) {
        // Long division
        // quotient q0 = x / y
        final double q0 = x / y;
        // remainder r0 = x - q0 * y
        DD2 q = multiply(y, yy, q0);
     ...
     * @return the inverse
     */
    static DD2 inverse(double y, double yy) {
     ...
     */
    static DD2 ldexp(double x, double xx, int exp) {
     ...
     * @see #frexp(double, double, int[])
     */
    static long fastPowScaled(double x, double xx, int n, DD2[] f) {
        // Edge cases.
        if (n == 0) {
            f[0] = new DD2(0.5, 0);
            return 1;
        ...
        if (Math.abs(f[0].hi) == HALF && f[0].lo == 0) {
            ...
            final double hi = 0.5 * Math.pow(2 * f[0].hi, n);
            // Propagate sign change (x*f.hi) to the zero
            final double lo = Math.copySign(0.0, x * f[0].hi * xx);
            f[0] = new DD2(hi, lo);
            return 1 + (b - 1) * n;
        }
        if (n < 0) {
            b = computeFastPowScaled(b, f[0].hi, f[0].lo, -n, f);
            // Result is a non-zero fraction part so inversion is safe
            f[0] = inverse(f[0].hi, f[0].lo);
            // Rescale to [0.5, 1.0]
            f[0] = frexp(f[0].hi, f[0].lo, exp);
            return -b + exp[0];
        }
        return computeFastPowScaled(b, f[0].hi, f[0].lo, n, f);
    }
     ...
     * @return Power of two scale factor (integral exponent).
     */
    private static long computeFastPowScaled(long exp, double x, double xx, int n, DD2[] f) {
     ...
     * @see #frexp(double, double, int[])
     */
    static long powScaled(double x, double xx, int n, DD2[] f) {
        // Edge cases.
        if (n == 0) {
            f[0] = new DD2(0.5, 0);
            return 1;
        ...
        return computePowScaled(b, f[0].hi, f[0].lo, n, f);
    }
    ...
    private static long computePowScaled(long exp, double x, double xx, int n, DD2[] f) {
     ...
     * @return s0
     */
    private static double norm3(double s0, double s1, double s2, double s3, MDD2 s12) {
        double q;
     ...
     * If {@code y = 0} the result is undefined.
     *
     * <p>This is special routine used in {@link #powScaled(double, double, int, DD2)}
     ...
     * @return the inverse
     */
    private static DD2 inverse3(double y, double yy, double yyy) {
     ...
     * @return s0
     */
    private static double multiply3(double a0, double a1, double a2, double b, MDD2 s12) {
     ...
     * @return s0
     */
    private static double add3(double a0, double a1, double a2, double b, MDD2 s12) {
     ...
     * @return s0
     */
    private static double add3(double a0, double a1, double a2, double b0, double b1, double b2, MDD2 s12) {
