 ...
 *
 * <p>This class is the original port from Commons Math. It is based on the dot2s
 * algorithm of Ogita with a split of the number using a masking of the mantissa
 * bits. This does not preserve precision during split multiplication as per Dekker's
 * split algorithm. However the split is faster with no branch points.
 */
public final class LinearCombinationDot2sSplitMask {
    /*
     * Caveat:
     *
    ...
    /** Private constructor. */
    private LinearCombinationDot2sSplitMask() {
        // intentionally empty.
    }
