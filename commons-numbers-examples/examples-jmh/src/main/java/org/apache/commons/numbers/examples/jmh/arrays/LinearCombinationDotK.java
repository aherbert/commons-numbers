 ...
 */
public final class LinearCombinationDotK {
    /*
     * Caveat:
     *
    ...
    /**
     * Compute the sum of the products of two sequences of factors to 4-fold precision.
     *
     * @param a Factors.
     * @param b Factors.
     * @return \( \sum_i a_i b_i \).
     * @throws IllegalArgumentException if the sizes of the arrays are different.
     */
    public static double value4(double[] a,
                                double[] b) {
        return value(a, b, 4);
    }

    /**
     * Compute the sum of the products of two sequences of factors to 5-fold precision.
     *
     * @param a Factors.
     * @param b Factors.
     * @return \( \sum_i a_i b_i \).
     * @throws IllegalArgumentException if the sizes of the arrays are different.
     */
    public static double value5(double[] a,
                                double[] b) {
        return value(a, b, 5);
    }

    /**
     * Compute the sum of the products of two sequences of factors to 6-fold precision.
     *
     * @param a Factors.
     * @param b Factors.
     * @return \( \sum_i a_i b_i \).
     * @throws IllegalArgumentException if the sizes of the arrays are different.
     */
    public static double value6(double[] a,
                                double[] b) {
        return value(a, b, 6);
    }

    /**
     * Compute the sum of the products of two sequences of factors to 7-fold precision.
     *
     * @param a Factors.
     * @param b Factors.
     * @return \( \sum_i a_i b_i \).
     * @throws IllegalArgumentException if the sizes of the arrays are different.
     */
    public static double value7(double[] a,
                                double[] b) {
        return value(a, b, 7);
    }

    /**
     * Compute the sum of the products of two sequences of factors to k-fold precision.
     *
     * @param a Factors.
     * @param b Factors.
