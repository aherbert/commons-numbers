...
public final class Selection {
     ...
     */
    public static void select(int fromIndex, int toIndex, double[] a, int... k) {
        IndexSupport.checkFromToIndex(fromIndex, toIndex, a.length);
        doSelect(fromIndex, toIndex, a, k);
    }
            ...
            if (end < toIndex) {
                for (int i = n; --i >= 0;) {
                    ...
                    if (v >= end) {
                        ...
                        IndexSupport.checkIndex(fromIndex, toIndex - 1, v);
                        k[i] = k[--n];
                        k[n] = v;
                    }
                }
