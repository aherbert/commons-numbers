...
§     */
    ...
    static Stream<double[]> testDoubleSort() {
        ...
        for (final int size : new int[] {10, 15}) {
            ...
            builder.add(a);
            for (int i = 0; i < 5; i++) {
                builder.add(rng.doubles(size).toArray().clone());
            }
        }
    ...
    @ParameterizedTest
    @MethodSource(value = {"testDoubleSort4Internal"})
    void testDoubleLowerMedian4dInternal(double[] values, int[] indices) {
        final int a = indices[0];
        final int b = indices[1];
        final int c = indices[2];
        final int d = indices[3];
    ...
    @ParameterizedTest
    @MethodSource(value = {"testDoubleSort4"})
    void testDoubleLowerMedian4d(double[] a) {
        // This method computes in place
        assertMedian(a, x -> {
    ...
    @ParameterizedTest
    @MethodSource(value = {"testDoubleSort4"})
    void testDoubleUpperMedian4d(double[] a) {
        // This method computes in place
        assertMedian(a, x -> {
